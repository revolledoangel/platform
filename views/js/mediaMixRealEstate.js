$(document).ready(function () {
    ...
    if (savedClient) { $('#filterClient').val(savedClient).trigger('change.select2'); }
    ...
    $('#filterClient').on('change', function () {
        sessionStorage.setItem('mmre_filterClient', $(this).val() || '');
    ...
    $('#filterPeriod').on('change', function () {
        sessionStorage.setItem('mmre_filterPeriod', $(this).val() || '');
    ...
    $('#mediaMixRealEstateTable tbody').on("click", ".btn-deleteMediaMix", function () {
        ...
        swal({
            ...
            if (result.value) {
                sessionStorage.setItem('mmre_filterClient', $('#filterClient').val() || '');
                sessionStorage.setItem('mmre_filterPeriod', $('#filterPeriod').val() || '');
