...
$(document).ready(function () {
    ...
    $('#addDetailModal').on('show.bs.modal', function () {
        ...
        if (cachedProjects && Array.isArray(cachedProjects) && cachedProjects.length > 0) {
            ...
            $.ajax({
                url: 'ajax/mediaMixEcommerceDetails.ajax.php',
                method: 'POST',
    ...
    $('#addDetailModal form').on('submit', function (e) {
        ...
        var mediaMixEcommerce_id = typeof window.mmreId !== 'undefined' ? parseInt(window.mmreId) : null;
        ...
        var missingFields = [];
        if (isNaN(mediaMixEcommerce_id)) missingFields.push('Mix de Medios');
        ...
        var body = {
            mediamixecommerce_id: mediaMixEcommerce_id,
        ...
        fetch('https://algoritmo.digital/backend/public/api/mmecommerce_details', {
            method: 'POST',
            headers: {
    ...
    $('#editDetailForm').on('submit', function (e) {
        ...
        fetch('https://algoritmo.digital/backend/public/api/mmecommerce_details/' + detail_id, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
