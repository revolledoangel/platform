...
if (!isset($_GET['mediaMixId']) || !is_numeric($_GET['mediaMixId'])) {
    echo '<script>window.location = "mediaMixEcommerce";</script>';
    return;
}

// 2. OBTENER SOLO EL MIX DE MEDIOS (NO DETALLES NI PROYECTOS)
$mmreData = MediaMixEcommerceDetails_Controller::ctrGetMediaMixById($_GET['mediaMixId']);
if (!$mmreData) {
    echo '<script>
        swal({
            type: "error",
            ...
            window.location = "mediaMixEcommerce";
        });
    </script>';
    return;
}
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="mediaMixEcommerce">Mix de Medios Ecommerce</a></li>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form role="form" method="post" autocomplete="off">
                        <input type="hidden" name="newmediaMixEcommerceId"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form id="editDetailForm" role="form" method="post" autocomplete="off">
                        ...
                        <input type="hidden" name="editmediaMixEcommerceId"
                            value="<?php echo htmlspecialchars($mmre['id']); ?>">
