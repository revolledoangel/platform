<?php
require_once __DIR__ . '/../controllers/lookerMenu.controller.php';
            ...
            if (preg_match('/^[\p{L}\p{N}\s\-\&\.\,\(\)]+$/u', $name)) {
                ...
                if ($code === "" || preg_match('/^[A-Z]{2}$/', $code)) {
                    ...
                    if ($httpCode === 201 || $httpCode === 200) {
                        ...
                        // Save looker_url locally if provided
                        if (!empty($_POST['newClientLookerUrl']) && !empty($cliente['id'])) {
                            LookerMenu_Controller::ctrSaveLookerUrl($cliente['id'], $_POST['newClientLookerUrl']);
                        }
