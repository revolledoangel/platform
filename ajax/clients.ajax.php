...
// Guardar looker_url localmente
if (isset($_POST['action']) && $_POST['action'] === 'save_looker_url') {
...
// Obtener looker_url local de un cliente
if (isset($_GET['action']) && $_GET['action'] === 'get_looker_url') {
    $clientId = isset($_GET['client_id']) ? (int)$_GET['client_id'] : 0;
    $url = $clientId ? LookerMenu_Controller::ctrGetLookerUrl($clientId) : '';
    header('Content-Type: application/json');
